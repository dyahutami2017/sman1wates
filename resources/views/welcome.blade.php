                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="/"><img class="logo-icon mr-2"
                                    src="./img/logo.png" alt="logo" style="width:80px"><span
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="header-hero-content text-center">
                            <h3 class="header-sub-title wow fadeInUp mb-2" data-wow-duration="1.3s" data-wow-delay="0.2s">
                                SELAMAT DATANG DI</h3>
                            <h2 class="header-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.5s">
                                SMA NEGERI 1 WATES</h2>
                            <div class="s003">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="header-hero-image text-center wow fadeIn" data-wow-duration="1.3s"
                            data-wow-delay="1.4s">
                            <img src="./img/bannersma.jpeg" alt="hero" style="width:100%;border-radius:5%">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="section-title text-center pb-40">
                        ...
                        <h3 class="title">Jurusan <span>yang ada di SMA N 1 Sleman</span></h3>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
                ...
                <div class="col-md-4">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s"
                        ...
                        <div class="services-content mt-30">
                            <h4 class="services-title"><a href="#">IPA</a></h4><br>
                            <h6>Ilmu Pengetahuan Alam</h6>
                            <p class="text">Jurusan yang mempelajari ilmu-ilmu eksakta</p>
                        </div>
                    </div> <!-- single services -->
                </div>
                <div class="col-md-4">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s"
                        ...
                        <div class="services-content mt-30">
                            <h4 class="services-title"><a href="#">IPS</a></h4><br>
                            <h6>Ilmu Pengetahuan Sosial</h6>
                            <p class="text">Jurusan yang mempelajari ilmu-ilmu sosial/kemanusiaan</p>
                        </div>
                    </div> <!-- single services -->
                </div>
            </div> <!-- row -->
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <div class="section-title text-center pb-40">
                        <div class="line m-auto"></div>
                        <h3 class="title">Berita Sekolah</span></h3>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
                ...
                <div class="col-lg-4">
                    <div class="single-testimonial">
                        ...
                        <div class="services-content mt-4 mb-4 text-center">
                            <a class="more" href="/detail_berita/{{$b->id}}">Read More  <i class="lni-chevron-right"></i></a>
                        </div>
