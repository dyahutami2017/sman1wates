                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <form action="/mapel" method="GET" class="navbar-form navbar-left row">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-warning btn-sm" href="/mapel/{{$mapel->id}}/edit"> <i class="far fa-edit text-white" aria-hidden="true"></i></a>
                                            <a class="btn btn-danger btn-sm" href="/mapel/{{$mapel->id}}/delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                        </td>
                                        @endif
                                    </tr>
                                    @endforeach
            ...
            <div class="modal-body">
                <form action="/mapel/create" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input name="nama_mapel" type="text" class="form-control" id="" placeholder="Nama Mata Pelajaran">
                    </div>
