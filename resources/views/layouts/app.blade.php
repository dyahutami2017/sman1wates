...
<body  style="background-image: url('images/bg-auth.jpg')">
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-laravel" style="background-color:#035397">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            <li class="nav-item">
                                <a class=" text-white ml-3" href="{{ route('register') }}">{{ __('Register') }}</a>
                            </li>
                        @else
